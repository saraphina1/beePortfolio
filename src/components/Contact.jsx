...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ozpongh', 'template_8jrd9ig', form.current, 'xAwy14H-paYPUNwlB')
      .then((result) => {
  ...
  return (
    <section id='contact'>
        ...
        <form className="contactForm" ref={form} onSubmit={sendEmail}>
            ...
            <div className='links'>
           <a href='https://www.linkedin.com/in/sarah-oyeyemi-b39031183/'> <img src={linkedln} alt='image' className='linkImage'/></a>
